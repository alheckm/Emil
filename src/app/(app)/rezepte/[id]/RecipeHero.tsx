...
/**
 * Der obere Teil der Rezeptkarte: Foto, zwei runde Knöpfe, Titel.
 *
 ...
 * unten in der Karte bei den Schlagwörtern, wo sie auf `--surface` sitzt.
 *
...
export function RecipeHero({
  ...
  return (
    /* 9:10 — im Entwurf gemessen: das Foto ist etwas höher als breit und nimmt
       knapp die Hälfte der Karte ein. */
