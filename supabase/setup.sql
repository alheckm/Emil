...
from (values
  ...
  ('Senf', 'gewuerze', false),
  ('Dijonsenf', 'gewuerze', false),
  ('Ketchup', 'gewuerze', false),
  ('Mayonnaise', 'gewuerze', false),
  ('Sojasauce', 'gewuerze', false),
  ('Fischsauce', 'gewuerze', false),
  ('Worcestershiresauce', 'gewuerze', false),
  ('Tabasco', 'gewuerze', false),
  ('Sriracha', 'gewuerze', false),
  ('Harissa', 'gewuerze', false),
  ('Tahini', 'gewuerze', false),
  ('Zitronensaft', 'gewuerze', false),
  ('Paprikapulver', 'noch-vorraetig', false),
  ('Currypulver', 'noch-vorraetig', false),
  ('Kurkuma', 'noch-vorraetig', false),
  ('Kreuzkümmel', 'noch-vorraetig', false),
  ('Kümmel', 'noch-vorraetig', false),
  ('Koriandersamen', 'noch-vorraetig', false),
  ('Muskatnuss', 'noch-vorraetig', false),
  ('Zimt', 'noch-vorraetig', false),
  ('Nelken', 'noch-vorraetig', false),
  ('Kardamom', 'noch-vorraetig', false),
  ('Lorbeerblatt', 'noch-vorraetig', false),
  ('Wacholderbeeren', 'noch-vorraetig', false),
  ('Senfkörner', 'noch-vorraetig', false),
  ('Chiliflocken', 'noch-vorraetig', false),
  ('Cayennepfeffer', 'noch-vorraetig', false),
  ('Getrockneter Oregano', 'noch-vorraetig', false),
  ('Getrockneter Thymian', 'noch-vorraetig', false),
  ('Getrockneter Rosmarin', 'noch-vorraetig', false),
  ('Majoran', 'noch-vorraetig', false),
  ('Italienische Kräuter', 'noch-vorraetig', false),
  ('Kräuter der Provence', 'noch-vorraetig', false),
  ('Gemahlener Kreuzkümmel', 'noch-vorraetig', false),
  ('Gemüsebrühe', 'noch-vorraetig', false),
  ('Rinderbrühe', 'noch-vorraetig', false),
  ('Hühnerbrühe', 'noch-vorraetig', false),
  ('Brühe', 'noch-vorraetig', false),
